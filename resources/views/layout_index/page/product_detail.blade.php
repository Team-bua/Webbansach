        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 slider-content">
                    <textarea type="text" placeholder="Nhập gì đó để nói (input something)..." rows="10" cols="63" id="text"
                        disabled>
                {!!  $product_detail->description !!}
                    ...
                    <div class="btn-sec">
                        <button class="btn btn-success btn-lg" id="btPlay" onclick="playAudio()"><i
                                class="fa fa-book"></i></button>

                        <button class="btn" onclick="AddCart('{{ $product_detail->id }}')">Thêm Vào Giỏ Hàng</button>
                        <button class="btn " onclick="BuyCart('{{ $product_detail->id }}')" data-toggle="modal"
                            data-target="#product_view">Mua Ngay</button>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-2">
                                                    ...
                                                    <textarea style="resize: none;" rows="4" cols="30" class="form-control"
                                                        placeholder="messenger" name="body" required></textarea>
                                                </div>
                                            </div>
                            ...
                            <div>
                                <section class="features">
                                    <ul>
                                        ...
                                        <li><i class="fas fa-check"></i>Ngày Phát Hành:{{ $product_detail->releasedate }}
                                        </li>
                                        ...
                                        <li><i class="fas fa-check"></i>Số Trang:{{ $product_detail->pagenumber }} Trang
                                        </li>
                                    </ul>
                                </section>
                            </div>
