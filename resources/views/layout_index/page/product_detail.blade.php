        ...
        <div class="container">
            ...
            <div class="row">
                                    ...
                                    <li class="list-inline-item active">
                                        <a id="carousel-selector-0" class="selected" data-slide-to="0"
                                            ...
                                            <img style="height:160px;width:120px;"
                                                src="{{ asset('images/product_detail/' . $product_detail->imagedetail[$i]) }}"
                                                class="img-fluid">
                                        </a>
                                    </li>
                                @endfor
                ...
                <div class="col-md-6 slider-content">
                    <p id="dox"tyle="text-align:justify">{!! $product_detail->description !!}</p>
                    <ul>
                        @if ($product_detail->promotion_price == 0)
                            <li>
                                <span class="name">Giá Bán</span><span class="clm">:</span>
                                <span class="price final"
                                    style="color:black">{{ number_format($product_detail->unit_price, 0, '', ',') }}VNĐ</span>
                        ...
                        @else
                            <li>
                                ...
                                <span
                                    class="price final">{{ number_format($product_detail->promotion_price, 0, '', ',') }}VNĐ</span>
                    ...
                    <div class="btn-sec">
                        <a href="javascript:"><button class="btn" onclick="AddCart('{{ $product_detail->id }}')">Thêm Vào
                                Giỏ Hàng</button></a>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 product_img">
                                <img src="{{ asset('images/product/' . $product_detail->image) }}" class="img-responsive"
                                    width="200px">
                            </div>
                            <div class="col-md-6 product_content">
                                ...
                                @if ($product_detail->promotion_price == 0)
                                    <h3 class="cost">
                                        ...
                                        {{ number_format($product_detail->unit_price, 0, '', ',') }}VNĐ
                                    @else
                                        ...
                                        <span class="glyphicon glyphicon-usd"></span>
                                        {{ number_format($product_detail->promotion_price, 0, '', ',') }}VNĐ
                                    </h3>
                                @endif
                                ...
                                <div class="btn-ground">
                                    ...
                                    <button type="button" class="btn btn-primary"><span
                                            class="glyphicon glyphicon-shopping-cart"></span> Thanh Toán</button>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-2">
                                            ...
                                            <textarea style="resize: none;" rows="4" cols="30" class="form-control"
                                                placeholder="messenger" required></textarea>
                                        </div>
                                    </div>
            ...
            <div id="last-product-wrapper">
                <div id="comment-list">
                    <ul>
                        ...
                        <li id="doccc" class="com-details">
                            Nếu bạn đọc bình luận này thì bố mẹ bạn sẽ chết trong vòng 5 năm . Để tránh khỏi điều này bạn
                            phải copy và gửi nó vào 5 truyện khác . Tôi vô cùng vô cung xin lỗi khong thể lấy mạng cha mẹ ra
                            cược được, làm ơn tha thứ cho tôi
                        </li>
                    </ul>
