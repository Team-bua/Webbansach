...
<section class="service">
    <ul class="service-list clearfix">
      <li>
        <p class="service-image"><img src="images/logoteambua.png" alt="Smart Swatch Editions"></p>
        <div class="inner">
      ...
      <li>
        <p class="service-image"><img src="images/logoteambua.png" alt="Web UI Kit Design"></p>
        <div class="inner">
      ...
      <li>
        <p class="service-image"><img src="images/logoteambua.png" alt="Mobile Optimization"></p>
        <div class="inner">
