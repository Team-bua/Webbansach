                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="col-xs pull-right">
                            <button class="btn btn-block btn-success btn" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">
                            <i class="fa fa-plus">&nbsp;Thêm loại sách</i></button>
                            ...
                            <div id="id01" class="modal" id="bookmodal">
                                <form id="TypeBook" class="modal-content animate" action="" method="post">
                                    ...
                                    <div class="container">
                                        ...
                                        <input type="text" placeholder="Mời nhập tên loại sách......" name="name" id="name" required>
