        ...
        <section class="content">
                        ...
                        <div class="box-header">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn btn-success"
                                                style="border:none; background-color:#4a4235;float:left;margin-bottom:5px;margin-left:2px"><i
                            ...
                            <div class="col-md-4 pull-right">
                                ...
                                <a class="btn btn-success"
                                    style="border:none; background-color:#4a4235;float: right;;margin-bottom:5px;margin-left:2px"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($product_type as $pro)
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-warning btn" id="edit-{{ $pro->id }}"
                                            ...
                                            <td>
                                                <form method="post" action="{{ route('book_type.destroy', [$pro['id']]) }}"
                                                    ...
                                                    <button class="btn btn-danger delType" id="del"
                                                        onclick="return alertDelete()"> Xóa </button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
                    ...
                    <div style="width:1000px" class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button style="border:none; background-color:#4a4235;" class="  btnmove btn-sm pull-right"
                                    style="margin-top:0px;" data-widget="remove"><i class="fa fa-times"></i></button>
                                ...
                                <form id="bookForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="width:250px" type="text" name="name" class="form-control"
                                            id="type_name" placeholder="Tên loại sách . . . . .">

                                    </div>
                                    <button style="border:none; background-color:#4a4235;" type="submit"
            ...
            <div class="modal fade" id="bookeditmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div style="width:1000px" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button style="border:none; background-color:#4a4235;" class="  btnmove2 btn-sm pull-right"
                                style="margin-top:0px;" data-widget="remove"><i class="fa fa-times"></i></button>
                        ...
                        <div class="modal-body">
                            <form id="bookEditForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="width:250px" type="text" id="name_type" name="name" class="form-control"
                                        id="type_name" placeholder="Tên loại sách . . . . .">

                                </div>
                                <button style="border:none; background-color:#4a4235;" type="submit" id="editsubmit "
                ...
                success: function(response) {
                    if (response) {
                        ...
                        var output = "<tr>" +
                            ...
                            "<td>" + "<button class='btn btn-warning btn' id='edit-" + type['id'] +
                            "' onclick='editType(this)' >Sửa </button>" + "</td>" + fromDelete +
                            "</tr>";
