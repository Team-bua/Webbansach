                    ...
                    <div style="width:1000px" class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button style="background-color:#4a4235" class="  btnmove btn-sm pull-right"
                            ...
                            <div class="modal-body">
                                <form id="bookForm">
                                    ...
                                    <button style="border-color: #4a4235;background-color:#4a4235" type="submit"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="bookEditForm">
                                ...
                                <button style="border-color: #4a4235;background-color:#4a4235" type="submit"
                                    id="editsubmit " class="btn btn-success"> Cập nhật </button>
                        ...
                        <tbody>
                            @foreach ($product_type as $pro)
                                        <tr>
                                            ...
                                            <td>
                                                <button style="margin-right:5px;float: left;" class="btn btn-warning btn" id="edit-{{ $pro->id }}"
